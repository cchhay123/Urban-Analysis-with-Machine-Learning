...
```{r}
citibike <- read.csv("./citibike_2015_100k.csv")
...
write.csv(bike_cleaned, "./citibike_2015.csv", row.names = F)
```
...
bike <- read.csv("./citibike_2015.csv")
...
month_change_rate_2014 <- read.csv("./citibike_2014_change_rate.csv")
